...
namespace
{
const int k3x3GridSize = 3;
const int kBoardSize = 9;
const int kBoardGrids = 81;
const std::array<char, 9> kAllTryChars = {'1','2','3','4','5','6','7','8','9'};

// given a 2d coordinate, get the 3x3 grid with that coord as the top left corner
void getGridGroup(
